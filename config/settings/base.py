...
MIDDLEWARE = [
    ...
    "apps.core.middleware.PublicLanguagePrefixRedirectMiddleware",
...
if (
    ...
    or FX_REFRESH_LOCK_TTL_SECONDS <= FX_REQUEST_CONNECT_TIMEOUT + FX_REQUEST_READ_TIMEOUT
...
HOSTAWAY_LISTING_CURRENCY_CACHE_TTL = env.int("HOSTAWAY_LISTING_CURRENCY_CACHE_TTL", default=300)
...
if HYPERPAY_ENABLED:
    ...
    if (
        ...
        or HYPERPAY_BASE_URL != HYPERPAY_APPROVED_BASE_URLS.get(HYPERPAY_ENVIRONMENT)
...
# Beat interprets every crontab below in Riyadh civil time. Keeping this
# explicit protects the documented 08:00 operations summary from a Celery or
