...
def test_alt_editor_lists_and_saves(client):
    ...
    prop = Property.objects.create(
        slug="p1", hostaway_listing_id=99001, name_ar="وحدة", name_en="Unit", name_fr="Unite",
    )
    img = PropertyImage.objects.create(
        property=prop, source=PropertyImage.Source.HOSTAWAY,
        hostaway_url="https://example.com/a.jpg", hostaway_image_id=1,
    )
