...
class Command(BaseCommand):
    ...
    def handle(self, *args: object, **options: Any) -> None:
        ...
        summary = (
            ...
            f"properties_deactivated={report.properties_deactivated}, "
            f"properties_failed={report.properties_failed}, "
            f"properties_auto_published={report.properties_auto_published}, "
            f"properties_pending_review={report.properties_pending_review}, "
            f"source_missing_marked={report.source_missing_marked}, "
