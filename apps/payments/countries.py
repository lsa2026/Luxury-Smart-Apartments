"""ISO 3166-1 alpha-2 validation shared by checkout and booking forms."""
...
def normalize_country_code(value: str) -> str:
    """Return a strict uppercase ISO country code or raise ``ValueError``."""
    code = value.strip().upper()
    if code not in ISO_ALPHA2_COUNTRY_CODES:
        raise ValueError("invalid_iso_country_code")
    return code
