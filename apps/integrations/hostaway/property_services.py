...
def _operational_defaults(listing: HostawayListing) -> dict[str, object]:
    ...
    defaults: dict[str, object] = {
        ...
        "allow_same_day_booking": listing.allow_same_day_booking,
        "same_day_booking_lead_time_hours": listing.same_day_booking_lead_time_hours,
        "check_in_time_start": listing.check_in_time_start,
        "check_out_time": listing.check_out_time,
        "instant_bookable": listing.instant_bookable,
        "time_zone_name": listing.time_zone_name,
