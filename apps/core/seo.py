...
def seo_diagnostics() -> dict[str, Any]:
    ...
    missing_alt = (
        ...
        .filter(Q(alt_text_ar="") | Q(alt_text_en="") | Q(alt_text_fr=""))
        .count()
    )
    ...
    return {
        ...
        "missing_seo_fr": properties.filter(seo_title_fr="").count(),
        ...
        "missing_languages": properties.filter(
            Q(name_ar="") | Q(name_en="") | Q(name_fr="")
        ).count(),
    }
